...
(function () {
    ...
    const PATHS = {
        ...
        dataRegion: "../../data/final/spike/region/spikemap_ukr_regions_v2.csv",
        dataDistrict: "../../data/final/spike/district/spikemap_ukr_districts_v2.csv",
        dataComuni: "../../data/final/spike/municipals/spikemap_ukr_municipals_v2.csv"
    };
    const width = 1000;
    const height = 700;
    const SPIKE_WIDTH = 8;
