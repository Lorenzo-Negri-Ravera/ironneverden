...
function initSubEventLineChart() {
    ...
    d3.json("../../data/final/sub_event_line_chart/sub_event_line_chart.json").then(function(raw_data) {
        ...
        // --- LEGENDA (SINCRONIZZATA CON FOOD CHART) ---
        ...
        const helpContent = {
            ...
            steps: [
                ...
                "<strong>Lines:</strong> Trends for specific conflict sub-types.",
                "<strong>Interaction:</strong> Click on the legend to filter and focus on a single event category."
            ]
        };
