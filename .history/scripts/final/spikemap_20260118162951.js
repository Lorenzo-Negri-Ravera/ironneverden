(function() { 
    ...
    Promise.all([
        ...
        const mapHelpContent = {
            ...
            steps: [
                "<strong>Colors:</strong> Red for Battles, Yellow for Explosions (shows dominant type).",
                "<strong>Spikes:</strong> Height represents the total number of fatalities.",
                "<strong>Interaction:</strong> Hover for details; use controls to filter event types."
            ]
        };
        if (typeof createChartHelp === "function") createChartHelp("#spike-help-container", "#spike-map-wrapper", mapHelpContent);
