(function() {
    ...
    // ==========================================
    // --- INTERAZIONE HELP (Nuovo blocco) ---
    // ==========================================
    // // Usa i selettori di classe per agganciarsi al TUO CSS esistente
    // document.addEventListener("DOMContentLoaded", function() {
    //     const trigger = document.querySelector(".chart-help-trigger");
    //     const overlay = document.querySelector(".chart-help-overlay");

    //     if (trigger && overlay) {
    //         trigger.addEventListener("click", function() {
    //             overlay.style.display = "flex"; // Mostra overlay (flex per centrare)
    //         });

    //         overlay.addEventListener("click", function() {
    //             overlay.style.display = "none"; // Nascondi al click
    //         });
    //     }
    // });
